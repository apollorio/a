...
/*
 * ARCH: apollo-journal / journal_news, journal_nota
 *
 ...
 *
 * OWNER     apollo-journal   16 arquivos PHP, 4517 LOC
 * RUNTIME   CPT/taxonomia/meta registrados por apollo-core (init:5)
 * UI        emite HTML (3); chrome é do apollo-templates
 * META      8 chaves tocadas, 8 SEM definição governante
 * REST      namespace não literal no código — 3 rotas (3 públicas)
...
define( 'APOLLO_JOURNAL_VERSION', '1.0.1' );
