 ...
 * Directory Part — Head
 *
 * Canonical Apollo document head + directory assets.
...
$groups_css_url = defined('APOLLO_GROUPS_URL')
    ? APOLLO_GROUPS_URL . 'assets/css/groups-directory.css'
    : plugin_dir_url(dirname(__DIR__)) . 'assets/css/groups-directory.css';
...
if (function_exists('apollo_render_document_open')) {
    apollo_render_document_open(
        array(
            'title'      => 'Apollo · ' . ($page_title ?? 'Grupos'),
