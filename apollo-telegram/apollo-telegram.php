 ...
 *
 * OWNER     apollo-telegram   60 arquivos PHP, 11066 LOC
 * RUNTIME   CPT/taxonomia/meta registrados por apollo-core (init:5)
 * UI        emite HTML (18); chrome é do apollo-templates
 * META      4 chaves tocadas
 * REST      apollo-telegram/v1 — 8 rotas (0 públicas)
 * REQUIRES  apollo-events
 *
 * NÃO FAÇA
