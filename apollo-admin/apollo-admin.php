 ...
 *
 * OWNER     apollo-admin   123 arquivos PHP, 16087 LOC
 * RUNTIME   CPT/taxonomia/meta registrados por apollo-core (init:5)
 * UI        emite HTML (4); chrome é do apollo-templates
 * META      20 chaves tocadas, 4 SEM definição governante
 * REST      namespace não literal no código — 18 rotas (0 públicas)
...
define( 'APOLLO_ADMIN_VERSION', '1.1.0' );
