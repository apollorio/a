...
/**
 * Styles — GPS / Locations Archive
 *
 * Complete CSS for the locations radar directory.
...
<style>
	...
	*::after {
	...
	/* ═══════════════════════════════════════════════════════════
		...
		═══════════════════════════════════════════════════════════ */
	.gps-hero {
		background: linear-gradient(160deg, var(--black-1) 0%, var(--black-2) 45%, #0f1515 100%);
	...
	.gps-hero__breadcrumb a {
		color: rgba(var(--rgb-t), 0.5);
		transition: color 0.3s;
	}

	.gps-hero__breadcrumb a:hover {
		color: var(--primary);
	}
	...
	.gps-pill.active .gps-pill__count {
		opacity: 0.85;
	}
	...
	.gps-search__input::placeholder {
		color: var(--muted);
	}

	.gps-search__input:focus {
		border-color: var(--primary);
		box-shadow: 0 0 0 3px var(--primary-glow);
	}

	.gps-search:focus-within i {
		color: var(--primary);
	}
	...
	.gps-active-filters.visible {
		display: flex;
	}

	.gps-active-filters__clear {
		font-size: 0.75rem;
		color: var(--primary);
		font-weight: 600;
		padding: 3px 10px;
	...
	.gps-active-filters__clear:hover {
		background: var(--primary);
		color: var(--white);
	}
	...
	.gps-card:hover .gps-card__image img {
		transform: scale(1.06);
	}

	.gps-card__image::after {
		content: '';
		position: absolute;
		bottom: 0;
		left: 0;
